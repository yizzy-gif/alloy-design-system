    ...
    <Table>
      ...
      <TableBody>
        ...
        <TableRow>
          ...
          <TableCell><CellText variant="secondary">Compact + centered Alloy Checkbox</CellText></TableCell>
        </TableRow>

        {/* CellControl — Alloy Switch */}
        <TableRow>
          <TableCell><CellText variant="muted">CellControl · Switch</CellText></TableCell>
          <TableCell>
            <CellControl>
              <Switch size="sm" defaultChecked />
            </CellControl>
          </TableCell>
          <TableCell><CellText variant="secondary">Alloy Switch toggle</CellText></TableCell>
        </TableRow>
