...
export interface Building03IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Building03Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Building03IconProps) {
