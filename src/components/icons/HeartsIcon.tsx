...
export interface HeartsIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function HeartsIcon({ size = 16, color = 'currentColor', strokeWidth, ...props }: HeartsIconProps) {
