...
export interface Camera01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const Camera01Icon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: Camera01IconProps) => {
