...
export interface Share06IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Share06Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Share06IconProps) {
