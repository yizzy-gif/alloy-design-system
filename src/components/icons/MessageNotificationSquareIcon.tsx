...
export interface MessageNotificationSquareIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const MessageNotificationSquareIcon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: MessageNotificationSquareIconProps) => {
