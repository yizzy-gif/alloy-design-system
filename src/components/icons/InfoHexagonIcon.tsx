...
export interface InfoHexagonIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function InfoHexagonIcon({ size = 16, color = 'currentColor', strokeWidth, ...props }: InfoHexagonIconProps) {
