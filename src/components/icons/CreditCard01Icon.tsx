...
export interface CreditCard01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const CreditCard01Icon = ({ size = 24, color = 'currentColor', strokeWidth, ...props }: CreditCard01IconProps) => {
