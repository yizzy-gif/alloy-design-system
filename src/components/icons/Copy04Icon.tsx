...
export interface Copy04IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Copy04Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Copy04IconProps) {
