...
export interface Home01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Home01Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Home01IconProps) {
