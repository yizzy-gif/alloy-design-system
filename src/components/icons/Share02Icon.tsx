...
export interface Share02IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Share02Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Share02IconProps) {
