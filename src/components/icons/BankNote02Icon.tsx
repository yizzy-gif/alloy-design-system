...
export interface BankNote02IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const BankNote02Icon = ({ size = 24, color = 'currentColor', strokeWidth, ...props }: BankNote02IconProps) => {
