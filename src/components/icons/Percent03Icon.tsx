...
export interface Percent03IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Percent03Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Percent03IconProps) {
