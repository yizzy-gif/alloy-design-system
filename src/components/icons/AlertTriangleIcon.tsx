...
export interface AlertTriangleIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const AlertTriangleIcon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: AlertTriangleIconProps) => {
