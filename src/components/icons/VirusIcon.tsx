...
export interface VirusIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function VirusIcon({ size = 16, color = 'currentColor', strokeWidth, ...props }: VirusIconProps) {
