...
export interface BankNote01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const BankNote01Icon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: BankNote01IconProps) => {
