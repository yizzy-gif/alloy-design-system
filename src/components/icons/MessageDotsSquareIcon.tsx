...
export interface MessageDotsSquareIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const MessageDotsSquareIcon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: MessageDotsSquareIconProps) => {
