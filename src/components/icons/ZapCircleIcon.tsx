...
export interface ZapCircleIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function ZapCircleIcon({ size = 16, color = 'currentColor', strokeWidth, ...props }: ZapCircleIconProps) {
