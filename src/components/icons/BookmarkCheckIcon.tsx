...
export interface BookmarkCheckIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function BookmarkCheckIcon({ size = 16, color = 'currentColor', strokeWidth, ...props }: BookmarkCheckIconProps) {
