...
export interface HelpHexagonIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function HelpHexagonIcon({ size = 16, color = 'currentColor', strokeWidth, ...props }: HelpHexagonIconProps) {
