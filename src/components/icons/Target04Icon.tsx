...
export interface Target04IconProps extends SVGProps<SVGSVGElement> {
  /** Width and height in px. Overridden by .artwork CSS when used inside a Button. */
  size?: number | string;
  strokeWidth?: number;
}

export const Target04Icon = ({ size = 24, color = 'currentColor', strokeWidth, ...props }: Target04IconProps) => {
