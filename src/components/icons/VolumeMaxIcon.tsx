...
export interface VolumeMaxIconProps extends SVGProps<SVGSVGElement> {
  /** Width and height in px. Overridden by .artwork CSS when used inside a Button. */
  size?: number | string;
  strokeWidth?: number;
}

export const VolumeMaxIcon = ({ size = 24, color = 'currentColor', strokeWidth, ...props }: VolumeMaxIconProps) => {
