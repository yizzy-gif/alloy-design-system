...
export interface LogIn02IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function LogIn02Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: LogIn02IconProps) {
