...
export interface Globe01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const Globe01Icon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: Globe01IconProps) => {
