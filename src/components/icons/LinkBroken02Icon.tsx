...
export interface LinkBroken02IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function LinkBroken02Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: LinkBroken02IconProps) {
