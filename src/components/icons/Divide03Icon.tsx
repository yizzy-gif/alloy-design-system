...
export interface Divide03IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Divide03Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Divide03IconProps) {
