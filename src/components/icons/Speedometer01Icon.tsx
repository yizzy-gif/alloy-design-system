...
export interface Speedometer01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Speedometer01Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Speedometer01IconProps) {
