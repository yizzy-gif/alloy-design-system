...
export interface GitBranch01IconProps extends SVGProps<SVGSVGElement> {
  /** Width and height in px. Overridden by .artwork CSS when used inside a Button. */
  size?: number | string;
  strokeWidth?: number;
}

export const GitBranch01Icon = ({ size = 24, color = 'currentColor', strokeWidth, ...props }: GitBranch01IconProps) => {
