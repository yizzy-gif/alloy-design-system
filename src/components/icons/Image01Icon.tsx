...
export interface Image01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const Image01Icon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: Image01IconProps) => {
