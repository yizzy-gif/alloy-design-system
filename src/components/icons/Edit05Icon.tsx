...
export interface Edit05IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Edit05Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Edit05IconProps) {
