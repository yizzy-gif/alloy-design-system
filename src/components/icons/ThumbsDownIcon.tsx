...
export interface ThumbsDownIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const ThumbsDownIcon = ({ size = 24, color = 'currentColor', strokeWidth, ...props }: ThumbsDownIconProps) => {
