...
export interface Tool01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Tool01Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Tool01IconProps) {
