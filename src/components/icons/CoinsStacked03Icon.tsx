...
export interface CoinsStacked03IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const CoinsStacked03Icon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: CoinsStacked03IconProps) => {
