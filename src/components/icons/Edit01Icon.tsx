...
export interface Edit01IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Edit01Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Edit01IconProps) {
