...
export interface Save02IconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export function Save02Icon({ size = 16, color = 'currentColor', strokeWidth, ...props }: Save02IconProps) {
