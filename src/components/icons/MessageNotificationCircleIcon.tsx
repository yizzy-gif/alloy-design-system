...
export interface MessageNotificationCircleIconProps extends SVGProps<SVGSVGElement> {
  size?: number | string;
  color?: string;
  strokeWidth?: number;
}

export const MessageNotificationCircleIcon = ({ size = 16, color = 'currentColor', strokeWidth, ...props }: MessageNotificationCircleIconProps) => {
